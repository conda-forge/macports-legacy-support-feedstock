...
validate_recipe_outputs "macports-legacy-support-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="macports-legacy-support-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi